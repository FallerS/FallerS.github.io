...
The second blog-post will provide more basic functions for risk measurement. In the end we will combine everything to get a basic analysis tool for return series. 
