...
We will need expected returns and a covariance matrix to get the efficient frontier. Let's work with historical results so we don't have to approach the estaimation of input parameters and its associated problems for now. 
