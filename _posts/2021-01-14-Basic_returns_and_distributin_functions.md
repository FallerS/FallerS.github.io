...
General Python and finance knowledge is assumed. There are also various sources for Python in general and finance-related topics in specific online to get the fundamentals, some can be found in the resources of this blog. 
...
The file includes several datasets one after the next in the same sheet based on weighting schemes. We will be working with the value-weighted dataset which begins with row 12 for the industries and ends based in the last update somewhere in 11.2020 or row 1145+. simply copy this dataset, first row being the industries, in a separate csv-file with the name ind30_m_valueweight_rets.csv.  

Load and adjust the data to make it more convenient to work with and take a look at the data. 
...
### Kurtosis
Relates to "fatness" of tails compared to normal distribution. Fatter tails describe more extreme outcomes as would be expected compared to a normal distribution as can be often seen with stock investments. 
